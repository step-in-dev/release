...
2. **step-in-dev-1.5.0-win-x64.self-hosted.zip** — может быть установлена только на одном компьютере, а доступ с остальных — через браузер.

[Инструкция по установке и запуску](https://github.com/step-in-dev/release/wiki/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B0-%D0%B8-%D0%B7%D0%B0%D0%BF%D1%83%D1%81%D0%BA-%D0%BE%D1%84%D0%BB%D0%B0%D0%B9%D0%BD%E2%80%90%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D0%B8-stepindev.com)

[Ссылка для скачивания](https://github.com/step-in-dev/release/releases/tag/1.5.0)

## 31 мая 2026
1. Расширен курс «Основы Python» (с классическими задачами на ввод/вывод). Добавлены задания на строки и на перевод математических выражений в линейную форму. Больше задач на различные темы.
2. Добавлена страница с редактором обстановок для Робота.
3. Изменен цвет шаблона с правильным рисунком для заданий с Черепахой с серого на синий.
4. Добавлена поддержка команды `colormode` для Черепахи.
5. Добавлено несколько задач повышенной сложности для Черепахи.
6. Добавлено несколько задач на `if` для Робота.
7. Для p5 добавлена функция для рисования координатной сетки `drawAxes()`.
8. Усложнено копирование условий заданий в буфер обмена.
9. Добавлены сочетания клавиш Ctrl+Enter (запуск решения на выполнение) и Ctrl+Shift+Enter (переход к следующей задаче). 

## 19 мая 2026
Исполнитель Робот в виде, принятом на StepInDev, теперь доступен в качестве модуля для стандартной десктопной версии Python. 

![Скриншот окна Робота](2026-05-19/intro8_ru.png)

Подробнее можно посмотреть здесь: [Исполнитель Робот](https://robot.stepindev.com/index_ru.html)

## 22 февраля 2026
Увеличен размер области для рисования для Черепахи. Предыдущий размер - 400x350 пикселей. Новый размер:
- в курсе с Черепахой - 550x366. Это позволит сделать рисунки для заданий крупнее;
- на странице "Python онлайн" - 600х470. Больше места для рисования.

## 11 октября 2025
Обновлен оффлайн вариант StepInDev (может работать без интернета).
Добавлена возможность запретить копирование команд с панели со справкой.

[Ссылка для скачивания](https://github.com/step-in-dev/release/releases)

## 13 сентября 2025
Оффлайн вариант StepInDev (может работать без интернета) теперь есть и для Linux. Доступна его предварительная версия.
