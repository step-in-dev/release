## 17 января 2025
1. Урок 7 курса с Черепашкой теперь содержит пример рисования только контура окружности (задание 7).
2. В условие задания 9 урока 7 Черепашки добавлено явное указание, что заливки быть не должно.
